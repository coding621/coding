package com.morpheus.coding.monitor.config;
 ...
 */
@Component
public class CodingStatusChangeNotifier extends AbstractStatusChangeNotifier {
    public CodingStatusChangeNotifier(InstanceRepository repository) {
        super(repository);
    }
