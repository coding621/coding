...
//import com.morpheus.coding.footstone.core.core.domain.BaseCoreEntity;
//
...
//    /** 1、数据源配置（开发or测试环境）  */
//    // url
//    private final static String DATASOURCE_URL = "jdbc:mysql://47.109.46.103:5506/coding-manage?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8";
//
//    // DriverName
...
//
//    // 模块名称
//    private final static String MODULE = "coding-" + YOUR_MODULE;
//
//
//
//
//    /** 3、包配置(包名主要给模板引用)  */
//    // 父包名
//    private final static String PARENT = "com.morpheus.coding." + YOUR_MODULE;
//
//    // controller包名
//    private final static String PACK_CONTROLLER = "com.morpheus.coding.web.controller." + YOUR_MODULE;
//
//    // service包名
...
//    private final static String PATH_CONTROLLER = PROJECTPATH +  "/coding-admin/src/main/java/com/coding/web/controller/" + YOUR_MODULE;
//
//    // service、serviceImpl、dto、vo、entity、mapper存储路径
//    private final static String PATH_COMMON = PROJECTPATH + "/"  + MODULE +  "/src/main/java/com/coding/" + YOUR_MODULE;
//
//    // mapper.xml存储路径
...
//    /** 6、表前缀（根据实际情况修改）  */
//
//    private final static String TABLE_PREFIX = "coding_";
//
//
//
//    /**
