...
import com.morpheus.coding.footstone.core.annotation.Anonymous;
...
import com.morpheus.coding.footstone.core.utils.uuid.Seq;
...
import com.morpheus.coding.project.service.ProjectFileService;
import com.morpheus.coding.project.service.file.UploadFileFactory;
...
import static com.morpheus.coding.footstone.core.core.domain.AjaxResult.error;
import static com.morpheus.coding.footstone.security.utils.SecurityUtils.getLoginUser;
...
public class ProjectFileController {
    ...
    public AjaxResult downloadFileList(@RequestParam("projectFileIds") String projectFileIds, HttpServletResponse response) {
        ...
        String totalZip = CodingConfig.getProfile() + "/tmp.zip";
