package com.morpheus.coding.project.job;
...
import com.morpheus.coding.project.domain.ProjectTaskNotify;
import com.morpheus.coding.project.domain.vo.project.task.TaskNotifyDTO;
import com.morpheus.coding.project.mapper.ProjectTaskMapper;
import com.morpheus.coding.project.mapper.ProjectTaskNotifyMapper;
...
//                            // 设置任务详情页
//                            String url = SsoUrlUtils.ssoCreate(appid, agentid, host + path + ssoPath + URLEncoder.encode(host + "/coding-project/my-task/info?taskId=" + taskNotifyDTO.getTaskId()));
...
//                            taskOvertimeRemindDTO.setLinkUrl(OAUtils.ssoCreate(host + "/coding-project/my-task/info?taskId=" + taskNotifyDTO.getTaskId()));
