...
//                        // 设置任务详情页
//                        String url = SsoUrlUtils.ssoCreate(appid, agentid, host + path + ssoPath + URLEncoder.encode(host + "/coding-project/my-task/info?taskId=" + projectTaskNotify.getTaskId()));
...
//                        taskOvertimeRemindDTO.setLinkUrl(OAUtils.ssoCreate(host + "/coding-project/my-task/info?taskId=" + projectTaskNotify.getTaskId()));
