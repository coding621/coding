...
import { getTaskListApi, deleteTaskApi } from "@/api/coding-project/my-task.js"
import { getProjectListApi } from "@/api/dashboard/index.js"
import { getStageListApi, getProjectTaskListApi } from "@/api/coding-project/my-project.js"
...
export default {
  ...
  methods: {
    ...
    handleInfo(row) {
      this.$router.push({ path: "/coding-project/my-task/info", query: { taskId: row.taskId } })
    },
    handleDelete(row) {
      const data = {
