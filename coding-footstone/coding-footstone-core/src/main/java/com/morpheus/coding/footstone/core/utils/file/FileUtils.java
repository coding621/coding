package com.morpheus.coding.footstone.core.utils.file;
...
public class FileUtils {
    ...
    public static String writeImportBytes(byte[] data) throws IOException {
        return writeBytes(data, CodingConfig.getImportPath());
    }
    ...
    /**
     * 获取文件名称 /profile/upload/2022/04/16/morpheus.png -- morpheus.png
     *
     * @param fileName 路径名称
     * @return 没有文件路径的名称
     */
    ...
    /**
     * 获取不带后缀文件名称 /profile/upload/2022/04/16/morpheus.png -- morpheus
     *
     * @param fileName 路径名称
     * @return 没有文件路径和后缀的名称
     */
