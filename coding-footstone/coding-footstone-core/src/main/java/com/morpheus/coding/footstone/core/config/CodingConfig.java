package com.morpheus.coding.footstone.core.config;
...
public class CodingConfig {
    ...
    public void setAddressEnabled(boolean addressEnabled) {
        CodingConfig.addressEnabled = addressEnabled;
    }
    ...
    public void setCaptchaType(String captchaType) {
        CodingConfig.captchaType = captchaType;
    }
