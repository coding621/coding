package com.morpheus.coding.footstone.notice.consumer;
...
import com.morpheus.coding.footstone.notice.domain.dto.*;
import com.morpheus.coding.footstone.notice.domain.dto.*;
import com.morpheus.coding.footstone.notice.domain.entity.WxResult;
import com.morpheus.coding.footstone.notice.utils.MessageUtils;
import com.morpheus.coding.footstone.notice.utils.RocketMqUtils;
...
public class OAMessageConsumer implements CommandLineRunner {
     ...
     * 消费组
     * */
    @Value("${coding.rocketMQ.group.wxMessage}")
