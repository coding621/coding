package com.morpheus.coding.footstone.notice.utils;
...
import com.morpheus.coding.footstone.notice.domain.dto.MessageDataDTO;
import com.morpheus.coding.footstone.notice.domain.dto.ProcessWxMessageStateUpdateDTO;
import com.morpheus.coding.footstone.notice.domain.entity.WxResult;
import com.morpheus.coding.footstone.notice.enums.ButtonStateEnum;
...
public class RocketMqUtils {
    ...
    @Value("${coding.rocketMQ.addr}")
    private void setAddr(String addr) {
        RocketMqUtils.addr = addr;
    }
    @Value("${coding.rocketMQ.topic.wxMessage}")
     ...
     * 推送到微信topic
     * */
    public static void push2Wx(com.morpheus.coding.footstone.notice.domain.entity.Message ob){
