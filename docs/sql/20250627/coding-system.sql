...
CREATE DATABASE  `coding-system` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
-- ----------------------------
-- Table structure for coding_async
-- ----------------------------
DROP TABLE IF EXISTS `coding_async`;
CREATE TABLE `coding_async` (
...
-- ----------------------------
-- Records of coding_async
-- ----------------------------
BEGIN;
COMMIT;

-- ----------------------------
-- Table structure for coding_oauth2_agree
-- ----------------------------
DROP TABLE IF EXISTS `coding_oauth2_agree`;
CREATE TABLE `coding_oauth2_agree` (
...
-- ----------------------------
-- Records of coding_oauth2_agree
-- ----------------------------
BEGIN;
COMMIT;

-- ----------------------------
-- Table structure for coding_oauth2_client
-- ----------------------------
DROP TABLE IF EXISTS `coding_oauth2_client`;
CREATE TABLE `coding_oauth2_client` (
  `id` varchar(64) DEFAULT NULL,
...
-- ----------------------------
-- Records of coding_oauth2_client
-- ----------------------------
BEGIN;
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_dept` (`dept_id`, `parent_id`, `ancestors`, `dept_name`, `order_num`, `leader`, `phone`, `email`, `status`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (100, 0, '0', '墨菲科技有限公司', 0, 'moroheus', '15833888121', 'morpheus@qq.com', '0', '0', 'admin', '2022-12-06 17:32:35', 'admin', '2024-03-05 06:48:31');
INSERT INTO `sys_dept` (`dept_id`, `parent_id`, `ancestors`, `dept_name`, `order_num`, `leader`, `phone`, `email`, `status`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (101, 211, '0,100,211', '墨菲技术研究院', 9, 'moroheus', '', 'morpheus@qq.com', '0', '0', 'admin', '2022-12-06 17:32:35', 'admin', '2024-03-05 06:48:56');
INSERT INTO `sys_dept` (`dept_id`, `parent_id`, `ancestors`, `dept_name`, `order_num`, `leader`, `phone`, `email`, `status`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (102, 100, '0,100', '长沙分公司', 2, 'moroheus', '15888888888', 'morpheus@qq.com', '0', '2', 'admin', '2022-12-06 17:32:35', '', NULL);
...
INSERT INTO `sys_dept` (`dept_id`, `parent_id`, `ancestors`, `dept_name`, `order_num`, `leader`, `phone`, `email`, `status`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (105, 101, '0,100,211,101', '测试部门', 12, 'moroheus', '15888888888', 'morpheus@qq.com', '0', '2', 'admin', '2022-12-06 17:32:35', 'admin', '2023-01-19 09:31:23');
...
INSERT INTO `sys_dept` (`dept_id`, `parent_id`, `ancestors`, `dept_name`, `order_num`, `leader`, `phone`, `email`, `status`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (107, 101, '0,100,211,101', '运维部门', 5, 'moroheus', '15888888888', 'morpheus@qq.com', '0', '2', 'admin', '2022-12-06 17:32:35', '', NULL);
INSERT INTO `sys_dept` (`dept_id`, `parent_id`, `ancestors`, `dept_name`, `order_num`, `leader`, `phone`, `email`, `status`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (108, 102, '0,100,102', '市场部门', 1, 'moroheus', '15888888888', 'morpheus@qq.com', '0', '2', 'admin', '2022-12-06 17:32:35', '', NULL);
INSERT INTO `sys_dept` (`dept_id`, `parent_id`, `ancestors`, `dept_name`, `order_num`, `leader`, `phone`, `email`, `status`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (109, 102, '0,100,102', '财务部门', 2, 'moroheus', '15888888888', 'morpheus@qq.com', '0', '2', 'admin', '2022-12-06 17:32:35', '', NULL);
...
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2001, '项目管理', 0, 2, 'coding-project', NULL, NULL, 1, 0, 'M', '0', '0', '', 'tab', 'admin', '2022-12-08 09:54:31', 'admin', '2024-03-05 06:02:10', '');
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2002, '我的项目', 2001, 1, 'my-project', 'coding-project/my-project', NULL, 1, 1, 'C', '0', '0', 'coding-project:my-project', 'list', 'admin', '2022-12-08 09:57:17', 'admin', '2024-03-05 06:02:00', '');
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2003, '我的收藏', 2001, 3, 'my-collection', 'coding-project/my-collection', NULL, 1, 1, 'C', '0', '0', 'coding-project:my-collection', 'list', 'admin', '2022-12-08 10:01:23', 'admin', '2024-03-05 06:02:30', '');
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2004, '我的任务', 2001, 2, 'my-task', 'coding-project/my-task', NULL, 1, 1, 'C', '0', '0', 'coding-project:my-task', 'list', 'admin', '2022-12-08 10:02:19', 'admin', '2024-03-05 06:02:23', '');
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2005, '回收站', 2001, 4, 'recycle-bin', 'coding-project/recycle-bin', NULL, 1, 1, 'C', '0', '0', 'coding-project:recycle-bin', 'list', 'admin', '2022-12-08 10:03:09', 'admin', '2024-03-05 06:02:38', '');
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2016, '详情', 2002, 4, '', NULL, NULL, 1, 0, 'F', '0', '0', 'coding-project:my-project:info', '#', 'admin', '2022-12-12 10:33:04', 'admin', '2024-04-03 17:40:11', '');
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2018, '详情', 2004, 1, '', NULL, NULL, 1, 0, 'F', '0', '0', 'coding-project:my-task:info', '#', 'admin', '2022-12-20 09:42:12', 'admin', '2024-06-01 15:45:21', '');
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_notice` (`notice_id`, `notice_title`, `notice_type`, `notice_content`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1, '温馨提醒：2018-07-01 coding新版本发布啦', '2', 0x3C703E3C696D67207372633D222F6465762D6170692F70726F66696C652F75706C6F61642F323032332F30312F30342F77616C6C686176656E2D7A386D7A6F765F3230323330313034313730333334413030332E706E67223EE696B0E78988E69CACE58685E5AEB93C2F703E, '0', 'admin', '2022-12-06 17:32:35', 'admin', '2023-01-04 17:03:37', '管理员');
INSERT INTO `sys_notice` (`notice_id`, `notice_title`, `notice_type`, `notice_content`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2, '维护通知：2018-07-01 coding系统凌晨维护', '1', 0xE7BBB4E68AA4E58685E5AEB9, '0', 'admin', '2022-12-06 17:32:35', '', NULL, '管理员');
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` (`user_id`, `dept_id`, `leader_id`, `user_name`, `user_wx_name`, `nick_name`, `user_type`, `email`, `phonenumber`, `sex`, `avatar`, `password`, `status`, `del_flag`, `login_ip`, `login_date`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1, 100, NULL, 'admin', NULL, '超级管理员', '00', 'admin@163.com', '15517519486', '0', '', '$2a$10$l4yTu8mRkOs9uHn54wZ5Zu3eQeghcTJQfQWa8uTF0kUMO7AmTkKkm', '0', '0', '183.69.244.46', '2024-05-22 17:04:57', 'admin', '2022-12-06 17:32:35', '', '2024-05-22 09:04:57', '管理员');
COMMIT;
