...
*/
CREATE DATABASE  `coding-workflow` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
-- ----------------------------
-- Table structure for coding_task_message_deal
-- ----------------------------
DROP TABLE IF EXISTS `coding_task_message_deal`;
CREATE TABLE `coding_task_message_deal` (
...
-- ----------------------------
-- Records of coding_task_message_deal
-- ----------------------------
BEGIN;
COMMIT;
...
-- ----------------------------
-- Table structure for coding_wf_category
-- ----------------------------
DROP TABLE IF EXISTS `coding_wf_category`;
CREATE TABLE `coding_wf_category` (
...
-- ----------------------------
-- Records of coding_wf_category
-- ----------------------------
BEGIN;
INSERT INTO `coding_wf_category` (`category_id`, `category_name`, `code`, `remark`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`) VALUES (1793475859094540290, '信息流转流程', '123456', '123456', '', NULL, '', NULL, '0');
COMMIT;

-- ----------------------------
-- Table structure for coding_wf_copy
-- ----------------------------
DROP TABLE IF EXISTS `coding_wf_copy`;
CREATE TABLE `coding_wf_copy` (
...
-- ----------------------------
-- Records of coding_wf_copy
-- ----------------------------
BEGIN;
COMMIT;

-- ----------------------------
-- Table structure for coding_wf_deploy_form
-- ----------------------------
DROP TABLE IF EXISTS `coding_wf_deploy_form`;
CREATE TABLE `coding_wf_deploy_form` (
...
-- ----------------------------
-- Records of coding_wf_deploy_form
-- ----------------------------
BEGIN;
COMMIT;

-- ----------------------------
-- Table structure for coding_wf_form
-- ----------------------------
DROP TABLE IF EXISTS `coding_wf_form`;
CREATE TABLE `coding_wf_form` (
...
-- ----------------------------
-- Table structure for coding_wf_model_deploy
-- ----------------------------
DROP TABLE IF EXISTS `coding_wf_model_deploy`;
CREATE TABLE `coding_wf_model_deploy` (
  `id` varchar(64) NOT NULL,
...
-- ----------------------------
-- Table structure for coding_wf_approval_set
-- ----------------------------
DROP TABLE IF EXISTS `coding_wf_approval_set`;
CREATE TABLE `coding_wf_approval_set`
(
...
-- ----------------------------
-- Records of coding_wf_approval_set
-- ----------------------------
BEGIN;
COMMIT;

CREATE TABLE `coding_materials_scrapped_process`
(
    `id`            varchar(64) NOT NULL,
...
-- ----------------------------
-- Records of coding_materials_scrapped_process
-- ----------------------------
BEGIN;
COMMIT;
